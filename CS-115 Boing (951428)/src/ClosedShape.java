...
public class ClosedShape {
	...
	/**
	 * True if the shape pulses, false if the shape remains a fixed size
	 */

	protected boolean pulses;
	...
	/**
	 * The x position vector of the Shape.
	 */
	protected int xVec;

	/**
	 * The y position vector of the Shape.
	 */
	protected int yVec;
	 ...
	 * @param pulses True if the shape pulses, false if the shape remains of a fixed size
	 */
	protected ClosedShape(int insertionTime, int x, int y, int vx, int vy, Color colour, boolean isFilled, boolean pulses) {
		this.xPos = x;
		this.yPos = y;
		this.xVec = vx;
		this.yVec = vy;
	...
	/**
	 * @return the boolean state of pulse true if the shape pulses false if the
	 *         shape does not pulse
	 */
