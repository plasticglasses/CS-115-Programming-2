 ...
 * The circle can pulse (grow and shrink in size) or remain a fixed size.
 */
...
public class Circle extends ClosedShape {
     ...
     */
    public Circle (int insertionTime, int x, int y, int vx, int vy, int diameter, Color colour, boolean isFilled , boolean pulses ) {
